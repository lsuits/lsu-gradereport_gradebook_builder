...
$string['help_step_3'] = 'Select a \'grading method\' from the drop-down menu.';
$string['help_step_4'] = 'Set/change category weights if you are using \'Custom weights.\' Adjust grade item points if needed.';
$string['help_step_5'] = 'Click on the \'Save to gradebook\' button. <br /><br />Note: Once you have saved to your gradebook, you can only make changes to categories and grade items in the \'full view\' or \'simple view\' within the gradebook. The Gradebook Builder for this course will no longer be available.';
